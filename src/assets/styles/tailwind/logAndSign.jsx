...
export const submitButton = "bg-gradient-to-r from-[#262626] to-[#202020] text-white border-none p-3 rounded-md text-base shadow-md hover:text-[#202020] hover:from-[#E8EAED] hover:to-[#E8EAED] transition-colors duration-300";
export const formFooter = "flex justify-around items-center mt-4";
export const formQuestion = "text-[inactive-color] text-lg text-[#202020]";


export const formContainerResponsive = "md:p-6";
export const formHeaderResponsive = "text-sm";
