...
export default function LandingPage() {
    return (
      <div className="flex min-h-screen w-full flex-col bg-[#262626]">
        <header className="sticky top-0 z-50 bg-[#262626] py-4 m-4">
          ...
          <section className="py-12 md:py-24 bg-[#262626] text-white">
            <div className="grid gap-12 lg:grid-cols-2">
              ...
              <div className="flex items-center justify-center">
                <div className="w-full h-64 bg-[#202020] rounded-lg shadow-lg"></div>
              </div>
            </div>
          </section>
            ...
            <div className="grid gap-12 lg:grid-cols-2">
              ...
              <div className="flex flex-col justify-center space-y-4">
                <h2 className="text-2xl font-bold text-[#262626] sm:text-3xl relative inline-block">
                  ...
                  <span className="absolute bottom-0 left-0 w-full h-1 bg-[#D90718]"></span>
                </h2>
        ...
        <footer className="border-t border-[#E5E7EB] bg-[#262626] text-white m-4">
